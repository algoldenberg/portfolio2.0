            ...
            <Col xs={12} md={6} xl={7}>
              <TrackVisibility>
                ...
                <div>
                  ...
                  <h1>Hello! I'm <span className="purpleText">Aleks</span><br/> <span className="txt-rotate" dataPeriod="200" data-rotate='[ "Web Developer..."]'><span className="wrap">{text}</span></span></h1>
